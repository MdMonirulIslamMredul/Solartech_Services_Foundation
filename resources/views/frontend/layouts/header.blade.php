         ...
         style="max-height: 50px; width: auto;">
                 ...
                 <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                     <ul class="navbar-nav ms-auto">
                         ...
                         <li class="nav-item">
                             <a href="{{ route('about.index') }}" style="font-size:18px; padding:20px 20px; line-height:1;text-decoration:none;">
                                 About Us
                             </a>
                         </li>
                         @php
                         ...
                         {{-- <li class="nav-item">
                             ...
                             <ul class="dropdown-menu">
                                 @foreach ($projects as $project)
                                     <li class="nav-item">
                                         <a href="/study_destination/{{ $project->id }}" class="nav-link">Study In
                                             {{ $project->title }}</a>
                                     </li>
                                 @endforeach
                             </ul>
                         ...
                         <li class="nav-item">
                             <a href="{{ route('gallery.index') }}"  style="font-size:18px; padding:20px 20px; line-height:1;text-decoration:none;">
                                 Gallery
                             </a>
                         </li>
                         <li class="nav-item">
