<style>
    ...
    .navbar-area .navbar-nav .nav-item.active .nav-link {
        background: rgba(41, 169, 224, 0.22);
        color: var(--sb-accent-cyan, #29A9E0) !important;
    ...
    .desktop-nav .navbar .navbar-nav .nav-item .dropdown-menu {
        ...
        border-top: 3px solid var(--sb-accent-cyan, #29A9E0) !important;
    ...
    .navbar-area .projects-status-item:focus {
        background: var(--sb-accent-light, #EBF7FC) !important;
        color: rgb(27, 58, 107) !important;
        border-left-color: var(--sb-accent-cyan, #29A9E0) !important;
    ...
    .projects-status-tab.active {
        background: #ffffff;
        border-color: #29a9e0;
        box-shadow: inset 0 0 0 1px #29a9e0;
        color: rgb(27, 58, 107);
    }
