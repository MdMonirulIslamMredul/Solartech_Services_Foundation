...
@section('content')
   ...
   @php
                ...
                @foreach ($sliders as $key => $slider)
                    <div class="slider-item">
                        ...
                        <div class="slider-content @if ($key == 0) active @endif">
                            ...
                            <p style="text-align: center; font-size: 22px;">{{ $slider->bottom_title }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
            ...
            <div class="row mb-4">
                <div class="col-lg-6 col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1000">
                    <div class="installation-card" style="position: relative; overflow: hidden; border-radius: 8px;">
                        <img src="{{ asset('setting/homepage/residential-solar.png') }}" alt="Residential Solar Installation"
                ...
                <div class="col-lg-6 col-md-6 mb-4" data-aos="fade-left" data-aos-duration="1000">
                    <div class="installation-card" style="position: relative; overflow: hidden; border-radius: 8px;">
                        <img src="{{ asset('setting/homepage/commercial-solar.jpg') }}" alt="Commercial Solar Installation"
                             style="width: 100%; height: 400px; object-fit: cover; display: block;">
                        <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(to top, rgba(186, 124, 26, 0.95), rgba(186, 124, 26, 0.8)); padding: 20px; text-align: center;">
    ...
    <div class="feature-item" style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="{{ asset('setting/brand/hybrid.png') }}" alt="Quick & Reliable" style="width: 100px; height: auto; margin-bottom: 30px;margin-top: 10px;">
    ...
    <!-- Feature 2 -->
    <div class="feature-item" style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="{{ asset('setting/brand/best_price.jpg') }}" alt="Affordable Price" style="width: 100px; height: auto; margin-bottom: 15px;">
    ...
    <!-- Feature 3 -->
    <div class="feature-item" style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="{{ asset('setting/brand/quality.png') }}" alt="High Quality Service" style="width: 100px; height: auto; margin-bottom: 15px;">
    ...
    <!-- Feature 4 -->
    <div class="feature-item" style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="{{ asset('setting/brand/eco.jpg') }}" alt="Eco Friendly" style="width: 100px; height: auto; margin-bottom: 15px;">
...
<div class="col-lg-4 d-flex justify-content-center align-items-start">
    <div class="faq-img text-center p-4 shadow-lg rounded-4"
       ...
       <img src="{{ asset('setting/brand/8ed0971d-71d2-4acf-bd05-8e9e76418d2c.png') }}"
             alt="FAQ Image"
             class="w-100 h-100"
                            ...
                            <div class="list">
                                <ul>
                                    <li><i class="flaticon-user"></i>
                                        By <a href="/blog/details/{{ $blog->id }}" style="text-decoration: none; color: #000;">Admin</a>
                                    </li>
                                </ul>
                            </div>
