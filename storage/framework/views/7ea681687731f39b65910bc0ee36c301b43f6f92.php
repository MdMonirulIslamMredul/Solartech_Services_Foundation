...
<?php $__env->startSection('title', __('Gellery')); ?>
    ...
    <?php if($images && count($images) > 0): ?>
        <div class="gallery-grid">
            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="gallery-card" data-aos="fade-up" data-aos-duration="800" data-aos-delay="<?php echo e($index * 50); ?>" onclick="openLightbox(<?php echo e($index); ?>)">
                    <div class="gallery-image-wrapper">
                        <img src="<?php echo e(asset('/setting/banner/' . $image->image)); ?>"
                             alt="Gallery Image <?php echo e($index + 1); ?> . <?php echo e($image->details); ?>">
...
<script>
    ...
    const galleryImages = [
        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            "<?php echo e(asset('/setting/banner/' . $image->image)); ?>",
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ];

    const galleryTitles = [
        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            "<?php echo e($image->details ?? 'Gallery Image'); ?>",
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ];
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Solartech_Services_Foundation\resources\views/frontend/content/allgallery.blade.php ENDPATH**/ ?>