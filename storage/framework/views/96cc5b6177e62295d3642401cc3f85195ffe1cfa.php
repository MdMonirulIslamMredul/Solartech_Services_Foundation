...
<div class="main-content">
    ...
    <div class="banner-area pb-100">
        <div class="container-fluid">
            <div class="hero-slider owl-carousel owl-theme" data-slider-id="1">
                <div class="slider-item" style="background-image: url('<?php echo e(asset('/setting/about/' . $about->banner_img)); ?>')">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 md-mb-30 slide-left" style="animation-delay: 0.2s;">
                    <div class="rs-animation-shape">
                        <div class="images">
                            <img src="<?php echo e(asset('/setting/about/' . $about->about_image)); ?>" alt="">
                        </div>
    ...
    <div style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="<?php echo e(asset('setting/brand/hybrid.png')); ?>" alt="Quick & Reliable" style="width: 80px; height: auto; margin-bottom: 30px;margin-top: 10px;">
    ...
    <!-- Feature 2 -->
    <div style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="<?php echo e(asset('setting/brand/best_price.jpg')); ?>" alt="Affordable Price" style="width: 80px; height: auto; margin-bottom: 15px;">
    ...
    <!-- Feature 3 -->
    <div style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="<?php echo e(asset('setting/brand/quality.png')); ?>" alt="High Quality Service" style="width: 80px; height: auto; margin-bottom: 15px;">
    ...
    <!-- Feature 4 -->
    <div style="flex: 1 1 calc(25% - 20px); text-align: center; min-width: 220px;">
        <img src="<?php echo e(asset('setting/brand/eco.jpg')); ?>" alt="Eco Friendly" style="width: 80px; height: auto; margin-bottom: 15px;">
...
<div class="row g-4" style="margin-bottom: 40px;">
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card-animated flip" style="animation-delay: 0.2s; background: #ffffff; padding: 40px; border-radius: 16px; box-shadow: 0 20px 30px rgba(0, 0, 0, 0.1); text-align: center; height: 100%;">
            ...
            <p style="font-size: 17px; line-height: 1.8; color: #333; text-align: justify; text-justify: inter-word;">
                <?php echo e($mission->mission_vision ?? 'Mission content is not available.'); ?>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card-animated flip" style="animation-delay: 0.4s; background: #ffffff; padding: 40px; border-radius: 16px; box-shadow: 0 20px 30px rgba(0, 0, 0, 0.1); text-align: center; height: 100%;">
            ...
            <p style="font-size: 17px; line-height: 1.8; color: #333; text-align: justify; text-justify: inter-word;">
                <?php echo e($mission->text ?? 'Vision content is not available.'); ?>
  ...
  <!-- License Section -->
    <div class="card-animated rotate" style="animation-delay: 0.6s; background: #ffffff; padding: 40px; margin-bottom: 30px; border-radius: 16px; box-shadow: 0 20px 30px rgba(0, 0, 0, 0.1); text-align: center;">
        ...
        <?php if($mission->pdf_file): ?>
            <a href="<?php echo e(asset('setting/mission/' . $mission->pdf_file)); ?>" target="_blank" class="btn-animated" style="padding: 12px 28px; background-color: #0d47a1; color: #fff; font-size: 16px; font-weight: 600; border: none; border-radius: 8px; cursor: pointer; box-shadow: 0 4px 12px rgba(13, 71, 161, 0.2); text-decoration: none;">
    ...
    <div class="card-animated rotate" style="animation-delay: 0.8s; background: #ffffff; padding: 40px; border-radius: 16px; box-shadow: 0 20px 30px rgba(0, 0, 0, 0.1); text-align: center;">
        ...
        <?php if($mission->portfolio): ?>
            <a href="<?php echo e(asset('setting/mission/' . $mission->portfolio)); ?>" target="_blank" class="btn-animated" style="padding: 12px 28px; background-color: #6a1b9a; color: #fff; font-size: 16px; font-weight: 600; border: none; border-radius: 8px; cursor: pointer; box-shadow: 0 4px 12px rgba(106, 27, 154, 0.2); text-decoration: none;">
                📄 View Portfolio
            </a>
        <?php else: ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Solartech_Services_Foundation\resources\views/frontend/about/index.blade.php ENDPATH**/ ?>