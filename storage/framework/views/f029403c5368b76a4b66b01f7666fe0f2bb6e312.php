...
<div class="service-banner <?php echo e($service->image1 ? 'has-bg' : ''); ?>" <?php if($service->image1): ?> style="background-image:url('<?php echo e(asset('/setting/service/' . $service->image1)); ?>')" <?php endif; ?>>
    <div class="inner" data-aos="fade-up" data-aos-duration="800">
        <h1><?php echo e($service->title); ?></h1>
        <?php if($service->details1): ?>
            <div class="lead"><?php echo Str::limit(strip_tags($service->details1), 170); ?></div>
        <?php endif; ?>
        <div class="crumbs">
            <a href="/">Home</a><span>/</span><a href="/service">Services</a><span>/</span><span><?php echo e($service->title); ?></span>
        </div>
    </div>
</div>

<div class="service-sections">
    <?php if($service->details1 || $images[0]): ?>
        <div class="service-row" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="media" data-aos="zoom-in" data-aos-duration="900" data-aos-delay="120">
                <figure>
                    <img src="<?php echo e(asset('/setting/service/' . $images[0])); ?>" alt="<?php echo e($service->title); ?> primary image">
                </figure>
            </div>
            <?php endif; ?>
            <?php if($service->details1): ?>
            <div class="content">
                <h2>Overview</h2>
                <div class="text"><?php echo $service->details1; ?></div>
            </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>

    <?php if($service->details2 || $images[1]): ?>
        <div class="service-row reverse" data-aos="fade-up" data-aos-duration="800">
            <?php if($service->details2): ?>
            <div class="content">
                <h2>More Details</h2>
                <div class="text"><?php echo $service->details2; ?></div>
            </div>
            <?php endif; ?>
            <?php if($images[1]): ?>
            <div class="media" data-aos="zoom-in" data-aos-duration="900" data-aos-delay="120">
                <figure>
                    <img src="<?php echo e(asset('/setting/service/' . $images[1])); ?>" alt="<?php echo e($service->title); ?> secondary image">
                </figure>
            </div>
            <?php endif; ?>
        </div>
    ...
    <?php if($service->details3 || $images[2]): ?>
        <div class="service-row" data-aos="fade-up" data-aos-duration="800">
            <?php if($images[2]): ?>
            <div class="media" data-aos="zoom-in" data-aos-duration="900" data-aos-delay="120">
                <figure>
                    <img src="<?php echo e(asset('/setting/service/' . $images[2])); ?>" alt="<?php echo e($service->title); ?> tertiary image">
                </figure>
            </div>
            <?php endif; ?>
            <?php if($service->details3): ?>
            <div class="content">
                <h2>Additional Info</h2>
                <div class="text"><?php echo $service->details3; ?></div>
            </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
...
<div class="cta-panel" data-aos="fade-up" data-aos-duration="900" data-aos-delay="150">
    <h2>Interested in <?php echo e($service->title); ?>?</h2>
    <p>Get in touch to learn how our <?php echo e($service->title); ?> solution can be tailored to meet your needs and deliver lasting performance and value.</p>
    <div class="cta-actions">
        <a href="<?php echo e(route('appointment.index')); ?>" class="cta-btn">Book Appointment</a>
        <a href="/contact" class="cta-btn secondary">Contact Us</a>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Solartech_Services_Foundation\resources\views/frontend/content/service_show.blade.php ENDPATH**/ ?>