...
<head>
  ...
  <style>
    body {
      ...
      */
        background-image: url("<?php echo e(asset('setting/banner/1763827137.jpg')); ?>");
...
<body class="min-h-screen flex items-center justify-center px-4">
  ...
  <div class="w-full max-w-md p-8 rounded-3xl glass text-white shadow-2xl">
    <div class="text-center mb-6">
      <img src="<?php echo e(asset('setting/banner/solar.png')); ?>" alt="Solar Panel Logo" class="logo-img mx-auto mb-4">
    ...
    <form action="<?php echo e(route('frontend.auth.login')); ?>" method="POST" class="space-y-5" id="loginForm">
        <?php echo csrf_field(); ?>
      <div>
...
<?php /**PATH C:\laragon\www\Solartech_Services_Foundation\resources\views/frontend/auth/login.blade.php ENDPATH**/ ?>