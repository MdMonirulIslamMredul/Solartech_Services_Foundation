                    ...
                    <div class="contact-and-address">
                        ...
                        <div class="cards-grid">
                            <div class="contact-card">
                                ...
                                <h4>Phone</h4>
                                <p><a href="tel:<?php echo e(get_setting('office_phone')); ?>"><?php echo e(get_setting('office_phone')); ?></a></p>
                                <p><a href="mailto:<?php echo e(get_setting('office_email')); ?>"><?php echo e(get_setting('office_email')); ?></a></p>
                            </div>
                            <div class="contact-card">
                        ...
                        <div class="social-media">
                            <h3>Social Media</h3>
                            <ul>
                                <li><a href="<?php echo e(get_setting('facebook')); ?>" target="_blank" aria-label="Facebook"><i class="ri-facebook-fill"></i></a></li>
                                <li><a href="<?php echo e(get_setting('twitter')); ?>" target="_blank" aria-label="Twitter"><i class="ri-twitter-fill"></i></a></li>
                                <li><a href="<?php echo e(get_setting('instagram')); ?>" target="_blank" aria-label="Instagram"><i class="ri-instagram-line"></i></a></li>
                                <li><a href="<?php echo e(get_setting('linkedin')); ?>" target="_blank" aria-label="LinkedIn"><i class="ri-linkedin-fill"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Solartech_Services_Foundation\resources\views/frontend/content/contact.blade.php ENDPATH**/ ?>