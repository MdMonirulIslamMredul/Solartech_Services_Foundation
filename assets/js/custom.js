(function ($) {
    ...
    $("body").append(
        "<div class='switch-box'><label id='switch' class='switch'><input type='checkbox' onchange='toggleTheme()' title=“Change Mode” id='slider'><span class='slider round'></span></label></div>"
    );
})(jQuery);
try {
